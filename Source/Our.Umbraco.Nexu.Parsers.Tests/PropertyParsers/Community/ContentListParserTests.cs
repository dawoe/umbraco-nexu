namespace Our.Umbraco.Nexu.Parsers.Tests.PropertyParsers.Community
{
    ...
    /// </summary>
    [TestFixture]
    public class ContentListParserTests : BaseParserTest
    {
        /// <summary>
        ...
        {
            // arrange
            var dataTypeDefinition = new DataTypeDefinition("Our.Umbraco.ContentList");

            var parser = new ContentListParser();
    ...
    {{  
        ...
        ""{related}"":""asflkasjf""
            ...
            var parser = new ContentListParser(contentTypeServiceMock.Object, dataTypeServiceMock.Object);
